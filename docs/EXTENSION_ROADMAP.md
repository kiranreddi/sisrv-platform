...
| 6 | 3-stage pipeline | Largest behavior change, best after ISA/peripheral baseline | Better IPC while preserving the same software contract | 76-test regression plus forwarding, load-use, flush, interrupt, throughput, and debug-step coverage |
