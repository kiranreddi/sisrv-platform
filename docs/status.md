...
| Headline result | ✅ Measured | `-O2`: `rv32im_zicsr` 1.502 CoreMark/MHz, 0.468 DMIPS/MHz, CPI 2.396; `rv32imc_zicsr` 1.462, 0.449, CPI 2.497 (M9 1-word fetch buffer closed ~84% of the C-extension gap — now within ~3%) |
