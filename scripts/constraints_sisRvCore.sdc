...
# OpenSTA lacks remove_from_collection; constrain only corebus response inputs.
set_input_delay  2.0 -clock clk [get_ports {req_ready rsp_valid rsp_rdata rsp_err}]
