...
module sis_uvm_platform_tb;
  ...
  // Overridable at compile time: -GUSE_AXIL=1 for AXI fabric coverage pass.
  localparam int USE_AXIL_P = 0;
  ...
  initial begin
    ...
    uvm_config_db#(virtual sis_jtag_if)::set(null, "*", "vif", jtag_if);
